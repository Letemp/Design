 ...
 */
public class DefineManager extends StaggeredGridLayoutManager {
    public DefineManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public DefineManager(int spanCount, int orientation) {
